...
test("every feature tag contributes to its deterministic signal", () => {
  ...
  const signals: Record<FeatureTag, Partial<CardListItem>> = {
    ...
    counter_focus: { counter: 2000, mechanics: ["Counter"] },
    finisher_focus: { cost: 8, power: 9000, mechanics: ["DoubleAttack"] },
  };
